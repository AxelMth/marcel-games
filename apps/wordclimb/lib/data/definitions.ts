export const definitions: Record<string, { en: string; fr: string }> = {
  ...
  card: {
    en: "A piece of thick, stiff paper or thin pasteboard, used for writing or printing on.",
    fr: "Un morceau de papier epais et rigide utilise pour ecrire ou imprimer.",
  },
  ward: {
  ...
  lane: {
    en: "A narrow road, especially in a rural area.",
    fr: "Un chemin etroit, surtout en zone rurale.",
  },
  late: {
  ...
  teal: {
    en: "A blue-green color; also a small freshwater duck.",
    fr: "Une couleur bleu-vert ; aussi un petit canard d'eau douce.",
  },
  tell: {
    en: "To communicate information, facts, or news to someone.",
    fr: "Communiquer des informations ou des nouvelles a quelqu'un.",
  },
  tall: {
  ...
  sore: {
    en: "A raw or painful place on the body; or feeling pain.",
    fr: "Un endroit douloureux sur le corps ; ou ressentir de la douleur.",
  },
  hare: {
  ...
  bond: {
    en: "A thing used to tie something or fasten things together; a connection or force between people.",
    fr: "Un lien qui attache des choses ensemble ; une connexion entre des personnes.",
  },
  bony: {
  ...
  mast: {
    en: "A tall upright post on a ship or boat, used to support sails.",
    fr: "Un poteau vertical sur un navire, utilise pour soutenir les voiles.",
  },
  malt: {
  ...
  will: {
    en: "The faculty by which a person decides on and initiates action; determination.",
    fr: "La faculte par laquelle une personne decide et initie une action.",
  },
  wile: {
  ...
  flaw: {
    en: "A mark, fault, or other imperfection that mars a substance or object.",
    fr: "Un defaut ou une imperfection qui altere une substance ou un objet.",
  },
  flay: {
    en: "To strip the skin off a body or carcass.",
    fr: "Enlever la peau d'un corps ou d'une carcasse.",
  },
  flat: {
  ...
  file: {
    en: "A folder or box for holding loose papers together; or a tool with a rough surface.",
    fr: "Un dossier pour tenir des papiers ensemble ; ou un outil a surface rugueuse.",
  },
  fill: {
  ...
  pane: {
    en: "A single sheet of glass in a window or door.",
    fr: "Une seule feuille de verre dans une fenetre ou une porte.",
  },
  pine: {
  ...
  clam: {
    en: "A marine bivalve mollusk with shells of equal size.",
    fr: "Un mollusque bivalve marin avec des coquilles de taille egale.",
  },
  clan: {
    en: "A group of close-knit and interrelated families; a large family.",
    fr: "Un groupe de familles etroitement liees ; une grande famille.",
  },
  plan: {
    en: "A detailed proposal for doing or achieving something.",
    fr: "Une proposition detaillee pour faire ou accomplir quelque chose.",
  },
}
